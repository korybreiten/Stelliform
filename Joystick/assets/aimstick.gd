...
export var action_left:String = "aim_left"	# -X Axis
export var action_right:String = "aim_right"	# +X Axis
export var action_up:String = "aim_up"		# -Y Axis
export var action_down:String = "aim_down"	# +Y Axis
...
onready var touch_detect = get_parent().get_node("Weapon_Button")

func _ready():
	if touch_detect.visible == false:
		visible = false
